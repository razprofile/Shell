...
/**
 * Mock version of the file system class. It provided mock versions of all 
 * methods that file system implements. The idea behind this class is the 
 * following
 * 
 * - the mock file system contains 5 mock directories and 1 mock file; the 
 * structure of mock file system cannot be changed; it's always the following:
 *      \
 *          dir
 *              childDir
 *              childFile
 ...
 *              childDir
 *              
 * - there are public static paths that correspond to all nodes in the 
 * mock files system; these are to be used for testing purposes
 * 
...
public class MockFileSystem implements IFileSystem {
  ...
  /**
   * Method to create new mock file at given path. Does not actually add file 
  ...
  /**
   * Method to create new mock directory at given path. Does not actually add 
   * directory to the mock file system.
   * 
   ...
   * @return reference to the parent of the node; null, node is not in mock
   *         file system
   */
  @Override
  ...
  /**
   * Method to move a node in mock file system from old location to 
   * new location
   * 
  ...
  /**
   * Method to copy a node in mock file system from old location to 
   * new location
   * 
  ...
  /**
   * Method to get string representation of mock file system. Always
   * returns (because the structure of mock file system is immulable):
   *    /
   *        dir
   *            childDir
   *            childFile
