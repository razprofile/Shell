...
public class ErrorTest {
  ...
  public void testErrorBadStringException() {
    ...
    assertEquals(" Please enter a correctly formatted string (Begins and ends "
        + "with double quotes, no double quotes within).",
        e.getError());
  }
  ...
  public void testErrorEmptyStackException() {
    ...
    assertEquals("There are no directories in the "
        + "stack to be popped.", e.getError());
  }
  ...
  public void testErrorNegativeNumberException() {
    ...
    assertEquals("%s is negative, please Enter a non-negative number", e.getError());
  }
