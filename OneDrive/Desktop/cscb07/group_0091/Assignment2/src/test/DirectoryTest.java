...
public class DirectoryTest {
  ...
  /**
   * Testing for Directory methods, create some working and children directories
   * and files
   * 
   * @author Sankalp Sharma
   */
  ...
  /*
   * check that children were added properly by checking if children exist 
  ...
  /*
   * Remove child returns the node that was just removed, so we check by 
  ...
  /*
   * Test get children by comparing size of collection and that 
   * the contains method contains both the childDir and the childFile
   */
  ...
  /*
   * Test the void version of removeChild by checking the state of the directory 
   * after performing removeChild. Check size of parent directory and 
   * whether the child has been successfully removed.
   */
  @Test
