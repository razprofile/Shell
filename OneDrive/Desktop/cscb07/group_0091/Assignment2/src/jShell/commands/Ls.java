...
public class Ls extends Command {
   ...
   * the directory, if path points to the file print the path of the file. 
   * This method assumes all arguments are valid
   * 
  ...
  BadFileNameException, RedirectionOperatorsException,
      RedirectionException, FileNotFoundException, NodeExistsException {
