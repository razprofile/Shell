...
/**
 * Save class handles all operations related to save command, namely, checks 
 * if the arguments are valid arguments for save command and saves the current
 * state of the shell to the specified file
 * 
