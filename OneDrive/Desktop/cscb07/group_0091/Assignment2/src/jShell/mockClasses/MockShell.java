...
public class MockShell extends IShell {
  ...
  /**
   * Method to mock shutting down the shell. Instead of actually shutting down 
   * the mock shell, record appropriate message to output
   */
  @Override
  ...
  /**
   * Method to mock the process of outputting string. Instead of printing to
   * console, save it to output
   * 
  ...
  /**
   * Method to mock the process of outputting error. Instead of printing to
   * console, save it to output
   * 
  ...
  /**
   * Method to mock the process processing input. Prints the appropriate message
   * to output
   * 
  ...
  /**
   * Method to mock the process of outputting string. Instead of printing to
   * console, save it to output with extra new line character
   * 
   * @param value String to be printed
   */
  @Override
