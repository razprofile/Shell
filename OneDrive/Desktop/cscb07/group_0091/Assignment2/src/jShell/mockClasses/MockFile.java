...
public class MockFile implements IFile{
  ...
  /**
   * Method to get a path to the mock file. There's only file in mock file 
   * system - childFile. If file is childFile, return paths to it in 
   * MockFileSystem. Otherwise, return arbitrary path
   * 
  ...
  /**
   * Method to mock setting changing contents of file. Does not actually
   * change the contents, but instead outputs appropriate message to the Shell,
   * which signalizes that this method is being called.
   * 
  ...
  /**
   * Method to get the contents of the mock file. Contents of the mock file
   * is always CONTENTS
   * 
