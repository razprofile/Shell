...
public abstract class FileSystemNode implements IFileSystemNode, Serializable{
  ...
  public IPath getPath() {
    ...
    for (Directory dir = (Directory)IShell.getShell().getFileSystem().
        getParent(this); 
      dir.getName() != IShell.getShell().getFileSystem().
          getRootDir().getName(); 
      dir = (Directory)IShell.getShell().getFileSystem().getParent(dir)) {
