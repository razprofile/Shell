...
public interface IPath {
  ...
  /**
   * Checks if path is equal to arbitrary object p. If p is a path, checks whether they have the
  ...
  /**
   * Checks if path is a valid relative path, that points to existing location in current file
   * system.
   * 
