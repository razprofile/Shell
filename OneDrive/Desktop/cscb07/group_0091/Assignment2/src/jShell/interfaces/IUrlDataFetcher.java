...
/**
 * Interface for getting the contents of an url. 
 * It is lso used for the url data fetcher and its mock version.
 * 
 * @author Sankalp Sharma
 */
...
public interface IUrlDataFetcher {
   ...
   * 
   * @param path to the URL in a string format
   * @return contents of the URL in a string format
